...
// import Acc_Summary from "../pages/panel/online-banking/Acc_Summary";
import Acc_Statement from "../pages/panel/online-banking/Acc_Statement";
import Acc_Summary from "../pages/panel/online-banking/Account";
import MyAccount from "../pages/panel/online-banking/AccountInfo";
import Transfer_Own_Account from "../pages/panel/online-banking/Transfer_Own_Account";
import Transfer_Third_Party from "../pages/panel/online-banking/Transfer_Third_Party";
import Transfer_Momo from "../pages/panel/online-banking/Transfer_Momo";

import ChequeBookRequest from "../pages/panel/online-banking/Cheque_Book_Request";
import Mobile_Banking_Request from "../pages/panel/online-banking/Mobile_Banking_Request";
import RequestHistory from "../pages/panel/online-banking/RequestHistory";
      ...
      <Routes>
        ...
        <Route path={`${process.env.PUBLIC_URL}`} element={<Layout />}>
          ...
          <Route path="crypto" >
            ...
            {/* <Route path="acc_summary" element={<WalletsBtc />}></Route> */}
         ...
         <Route path="own_account" element={<Transfer_Own_Account />}></Route>
         ...
         <Route path="investment_history" element={<InvestmentHistory />}></Route>
         <Route path="fixed_deposit" element={<FixedDeposit />}></Route>
         <Route path="tbills_request" element={<Tbills_Request />}></Route>
