            ...
            <React.Fragment>
              <div className="nk-sidebar-widget d-none d-xl-block">
                <div className="user-account-info between-center">
                  <div className="user-account-main">
                    ...
                    <div className="user-balance">
                      2.014095 <small className="currency currency-btc">GHC</small>
                    </div>
                    <div className="user-balance-alt">
                      18,934.84 <span className="currency currency-btc">GHC</span>
                    </div>
                  </div>
                ...
                <ul className="user-account-data gy-1">
                  <li>
                    ...
                    <div className="user-account-value">
                      <span className="lead-text">
                        + 0.0526 <span className="currency currency-btc">GHC</span>
                      </span>
                  ...
                  <li>
                    <div className="user-account-label">
                      <span className="sub-text">Deposit for this week</span>
                    </div>
                    <div className="user-account-value">
                      <span className="sub-text">
                        0.005400 <span className="currency currency-btc">GHC</span>
                      </span>
                    </div>
                  </li>
                </ul>
