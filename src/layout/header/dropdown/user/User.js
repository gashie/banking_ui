      ...
      >
        <div className="user-toggle">
          ...
          <div className="user-info d-none d-md-block">
            <div className="user-status">Customer</div>
            <div className="user-name dropdown-indicator">Rahim</div>
          </div>
        </div>
      </DropdownToggle>
        ...
        <div className="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
          <div className="user-card sm">
            ...
            <div className="user-info">
              <span className="lead-text">Rahim Kunge</span>
              <span className="sub-text">rahim@test.com</span>
            </div>
          </div>
        </div>
