    ...
    <React.Fragment>
      ...
      <Card className="card-bordered" inverse color="gray">
        ...
        <CardBody className="card-inner">
          ...
          <CardText>PAPPS Transfer</CardText>
        </CardBody>
      </Card>
      <Content>
            ...
            <Form className="buysell-form">
              ...
              <div className="form-group">
                <Label className="form-label" htmlFor="fv-topics">
                 Beneficiary Destination Account Institution
                </Label>
                <div className="form-control-wrap">
                  <div className="form-control-select">
                    <select className="form-control form-select" id="fv-topics" placeholder="Select Institution for the destination">
                      <option label="Select Institution for the destination" value=""></option>
                      <option value="fv-gq">Ecobank Nigeria</option>
                      <option value="fv-tq">Fidelity Ghana</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div className="form-group">
                ...
                <div className="form-control-wrap">
                  <div className="form-control-select">
                    <select className="form-control form-select" id="fv-topics" placeholder="Select Currency">
                      <option label="Select Currency" value=""></option>
                      <option value="fv-gq">GHC (GHC)</option>
