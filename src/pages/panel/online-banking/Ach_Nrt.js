          ...
          <div className="buysell-block">
            <Form className="buysell-form">
              ...
              <div className="form-group">
                ...
                <div className="form-control-wrap">
                <select className="form-control form-select" id="fv-topics" placeholder="Select Bank">
                      <option label="Select Bank" value=""></option>
                      <option value="fv-gq">CALBANK PLC </option>
