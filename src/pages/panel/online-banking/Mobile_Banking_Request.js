    ...
    <React.Fragment>
      ...
      <Card className="card-bordered" inverse color="gray">
        ...
        <CardBody className="card-inner">
          <CardTitle tag="h5">Request</CardTitle>
          <CardText>Mobile Banking Request</CardText>
        </CardBody>
      </Card>
      <Content>
          ...
          <div className="buysell-block">
            <Form className="buysell-form">
              ...
              <div className="form-note text-base text-center">
                Note: mobile banking request fee included,{" "}
...
export default MobileBankingRequest;
