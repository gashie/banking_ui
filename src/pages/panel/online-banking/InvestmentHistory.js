...
import { statusOptions, transData ,investmentData} from "../../pre-built/trans-list/TransData";
...
const InvestmentHistory = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = investmentData.filter((item) => {
    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>Investment History</BlockTitle>
              <BlockDes className="text-soft">
                <p>You have total 0 investment.</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
              ...
              <div className="card-inner">
                <div className="card-title-group">
                  <div className="card-title">
                    <h5 className="title">All Investment</h5>
                  </div>
                  ...
                  <thead>
                    <tr className="tb-tnx-head">
                      ...
                      <th className="tb-tnx-amount is-alt">
                        ...
                        <span className="tb-tnx-total">Value Date</span>
                            ...
                            <tr key={item.id} className="tb-tnx-item">
                              ...
                              <td className="tb-tnx-info">
                                <div className="tb-tnx-desc">
                                  <span className="title">{item.req_type}</span>
                                </div>
                                <div className="tb-tnx-date">
                                  <span className="date">{item.req_date}</span>
                                  {/* <span className="date">{item.dest}</span> */}
                                </div>
                              </td>
