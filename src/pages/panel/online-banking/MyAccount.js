...
import { statusOptions, transData,accountData } from "../../pre-built/trans-list/TransData";
...
const MyAccount = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = accountData.filter((item) => {
    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>Account Info</BlockTitle>
              <BlockDes className="text-soft">
                <p>You have  1 account.</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
                            ...
                            <tr key={item.id} className="tb-tnx-item">
                              ...
                              <td className="tb-tnx-info">
                                <div className="tb-tnx-desc">
                                  <span className="title">{item.acc}</span>
                                </div>
                              ...
                              <td className="tb-tnx-amount is-alt">
                                <div className="tb-tnx-total">
                                  <span className="amount">{item.email}</span>
                                </div>
                                <div className="tb-tnx-status">
                                  <Badge
                                    className="badge-dot"
                                    color={
                                      item.status === "Approved" ? "success" : item.status === "Due" ? "warning" : "danger"
                                    }
                                  >
                                    {item.status}
                                  </Badge>
