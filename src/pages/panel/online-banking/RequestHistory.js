...
import { statusOptions, transData ,requestData} from "../../pre-built/trans-list/TransData";
...
const RequestHistory = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = requestData.filter((item) => {
    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>Request History</BlockTitle>
              <BlockDes className="text-soft">
                <p>You have total 2 Request.</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
              ...
              <div className="card-inner">
                <div className="card-title-group">
                  <div className="card-title">
                    <h5 className="title">All Request</h5>
                  </div>
