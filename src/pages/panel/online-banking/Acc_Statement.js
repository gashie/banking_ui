...
import {
  ...
  filterStatusOptions,
  orderData,
} from "../../pre-built/trans-list/TransData";
    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>Account Statement</BlockTitle>
        ...
        <Block>
          <DataTable className="card-stretch">
            <div className="card-inner">
              <div className="card-title-group">
                <div className="card-title">
                  <h5 className="title">Statement</h5>
                </div>
                      ...
                      <UncontrolledDropdown>
                        ...
                        <DropdownMenu end className="filter-wg dropdown-menu-xl">
                          <div className="dropdown-head">
                            <span className="sub-title dropdown-title">Account Statement Filter</span>
                            ...
                            <Row className="gx-6 gy-4">
                              <Col size="12">
                                <div className="form-group">
                                  <label className="overline-title overline-title-alt">Account</label>
                                  <RSelect options={accountActivityOptions} placeholder="My Account" />
                                </div>
                              </Col>
                              <Col sm="6">
                                <div className="form-group">
                              ...
                              <Col size="12">
                                <div className="form-group">
                                  <Button type="button" className="btn btn-secondary" onClick={() => setshowAccount(true)}>
                                    Filter
                                  </Button>
                                </div>
                              </Col>
            ...
            <DataTableBody bodyclass="nk-tb-tnx">
              ...
              {showAccount && currentItems.length > 0
                      ...
                      <DataTableItem key={item.id}>
                        ...
                        <DataTableRow className="text-end">
                          <span className="tb-amount">
                            + {item.amountBTC} <span>GHC</span>
                          </span>
                          <span className="tb-amount-sm">{item.amountUSD} GHC</span>
                        </DataTableRow>
                        <DataTableRow className="text-end" size="sm">
                          <span className="tb-amount">
                            {item.balanceBTC} <span>GHC</span>
                          </span>
                          <span className="tb-amount-sm">{item.balanceUSD} GHC</span>
                        </DataTableRow>
                        <DataTableRow className="nk-tb-col-status">
                          <div
                            className={`dot dot-${
