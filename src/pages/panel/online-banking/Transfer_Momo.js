    ...
    <React.Fragment>
      ...
      <Card className="card-bordered" inverse color="gray">
        ...
        <CardBody className="card-inner">
          ...
          <CardText>Mobile Money(Momo) Transfer</CardText>
        </CardBody>
      </Card>
      <Content>
              ...
              <div className="form-group">
                ...
                <div className="form-control-wrap">
                  <div className="form-control-select">
                    <select className="form-control form-select" id="fv-topics" placeholder="Select Network">
                      <option label="Select Network" value=""></option>
                      <option value="fv-gq">AT</option>
                      <option value="fv-tq">Telecel</option>
                      <option value="fv-gq">MTN</option>
                      <option value="fv-tq">VodaCash</option>
                    </select>
                  </div>
                </div>
              </div>
