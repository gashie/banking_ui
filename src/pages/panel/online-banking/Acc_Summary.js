          ...
          <div className="nk-block-between-md">
            <BlockHeadContent>
              ...
              <div className="nk-wgwh">
                <Icon name="coins" className="icon-circle icon-circle-lg icon" />
              ...
              <div className="nk-wg1">
                <div className="nk-wg1-group g-2">
                    <div className="nk-wg1-item me-xl-4">
                        ...
                        <div className="amount">Ghc 650,0000 </div>

                            {/* <div className="amount">Ghc 2.010550 <small className="currency currency-usd">{currency}</small></div> */}
                ...
                <div className="card-inner">
                  <div className="nk-wg5">
                      ...
                      <div className="nk-wg5-text">
                          <div className="nk-wg5-amount">
                              <div className="amount">
                                  100,000 <span className="currency currency-btc">GHC</span>
                              </div>
                      ...
                      <div className="nk-wg5-foot">
                          <span className="text-soft">Last Send at <span className="text-base">19 Sept, 2024</span></span>
                      </div>
                  </div>
                </div>
              </Card>
                ...
                <div className="card-inner">
                  <div className="nk-wg5">
                      ...
                      <div className="nk-wg5-text">
                          <div className="nk-wg5-amount">
                              <div className="amount">
                                  650,0000 <span className="currency currency-btc">GHC</span>
                              </div>
                              {/* <div className="amount-sm">
                                  972,360.72 <span className="currency currency-usd">USD</span>
                              </div> */}
                      ...
                      <div className="nk-wg5-foot">
                          <span className="text-soft">Last Recive at <span className="text-base">19 Sept, 2024</span></span>
                      </div>
                  </div>
                </div>
              </Card>
                ...
                <div className="card-inner">
                  <div className="nk-wg5">
                      ...
                      <div className="nk-wg5-text">
                          <div className="nk-wg5-amount">
                              <div className="amount">
                                  500,000 <span className="currency currency-btc">GHC</span>
                              </div>
                              {/* <div className="amount-sm">
                                  972,360.72 <span className="currency currency-usd">USD</span>
                              </div> */}
                      ...
                      <div className="nk-wg5-foot">
                          <span className="text-soft">Last Withdraw at <span className="text-base">19 Sept, 2024</span></span>
                      </div>
                  </div>
                </div>
              </Card>
