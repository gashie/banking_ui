...
import { statusOptions, transData ,transferData} from "./TransData";
...
const TransListBasic = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = transferData.filter((item) => {
          ...
          <BlockBetween>
            <BlockHeadContent>
              ...
              <BlockDes className="text-soft">
                <p>You have total 937 transactions.</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
                            ...
                            <tr key={item.id} className="tb-tnx-item">
                              ...
                              <td className="tb-tnx-info">
                                ...
                                <div className="tb-tnx-date">
                                  <span className="date">{item.source}</span>
